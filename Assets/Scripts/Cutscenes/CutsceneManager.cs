    ...
    IEnumerator SkipLoop()
    {
        ...
        for (int j = _skipPos - 1; j < _skipEvent.cutsceneScript.Count; j++)
        {
            ...
            if (i.GetType() == typeof(CutsceneDialogue) || i.GetType() == typeof(ScriptedWait) ||
                ...
                i.GetType() == typeof(DisplayImage) || i.GetType() == typeof(GetDummyItem))
            {
            ...
            // Performs state-changing events that happen instantaneously by default
                     ...
                     i.GetType() == typeof(SetCurrentMission) ||
                     ...
                     i.GetType() == typeof(SetSortingLayer) ||
                     ...
                     i.GetType() == typeof(StopTimer) || i.GetType() == typeof(SaveEvent) ||
                     i.GetType() == typeof(ResetCollectibles) ||
                     i.GetType() == typeof(AlterCollectibleCount) ||
                     i.GetType() == typeof(ResetFishTable) ||
                     i.GetType() == typeof(AwardEventAchievement))
            {
                i.PlayEventFunction();
